...
*/
    ...
    Route::group(['middleware' =>  ['auth:customer', 'context', 'abcccontext:customer']], function()
    {
...
//        Route::get('/cart/add/{id}', 'AbccCustomerCartController@addItem')->name('abcc.addToCart');
        ...
        Route::post('cart/updateaddress', 'AbccCustomerCartController@updateCartAddress')->name('abcc.cart.updateaddress');
