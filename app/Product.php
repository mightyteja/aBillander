...
class Product extends Model
{
    ...
    public static $procurement_types = [
        'purchase',
        'manufacture',
        'assembly',
        'none',
    ...
    */
    ...
    public function getStockBadgeAttribute()
    {
        ...
        if ($value > Configuration::get('ABCC_STOCK_THRESHOLD')) {
            return 'success';
        }
    ...
    public function getCostPriceAttribute($value)
    {
        ...
        if (\Illuminate\Support\Facades\Auth::guard('salesrep')->check()) {
            return 0.0;
        }
    ...
    */
    ...
    {
        if ($this->out_of_stock == 'default') {
            return Configuration::get('ABCC_OUT_OF_STOCK_PRODUCTS');
        }
    ...
    */
    ...
    public function getTaxRulesByProduct(Address $address = null)
    {
        ...
        if (1 && $this->ecotax) {
            ...
            if ($rules_eco->isNotEmpty()) {
                $rules = $rules->merge($rules_eco);
            }
