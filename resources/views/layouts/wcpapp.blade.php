...
<head>
    ...
    <title>@yield('title') - WebClientPrint 5.0 for PHP</title>
    ...
    <div class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="//www.neodynamic.com/products/printing/raw-data/php/download/" target="_blank" class="navbar-brand">WebClientPrint <span class="round white">5.0</span> for PHP - Laravel</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li><a href="{{action('DemoPrintHomeController@index')}}">Home</a></li>
                    <li><a href="{{action('DemoPrintHomeController@samples')}}">Samples</a></li>
                    <li><a href="{{action('DemoPrintHomeController@printersinfo')}}">Printers</a></li>
