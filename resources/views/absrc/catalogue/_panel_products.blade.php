...
<div class="page-header">
    ...
    <h2>
        @if ( count($breadcrumb) )
           <a class="btn btn-sm btn-primary" href="{{ route('absrc.catalogue') }}" title="{{l('Home', 'layouts')}}"><i class="fa fa-home"></i></a> 
...
@endif
      ...
      <td>
              ...
              <div class="progress progress-striped">
                <div class="progress-bar progress-bar-{{ $product->stock_badge }}" title="{{ l('stock.badge.'.$product->stock_badge, 'absrc/layouts') }}" style="width: 100%">
            ...
            <div xclass="form-group">
              <div class="input-group" style="width: 72px;">
                ...
                <span class="input-group-btn">
                  <button class="update-product-quantity btn btn-sm btn-info" data-id="{{$product->id}}" type="button" title="{{l('Add to Cart', 'absrc/layouts')}}" xonclick="add_discount_to_order($('#order_id').val());">
...
@else
            <a class="btn btn-sm btn-warning show-out-of-stock"  data-html="false" data-toggle="modal" 
                ...
                title="{{l('Click for more Information', 'absrc/layouts')}}" 
                onClick="return false;"><i class="fa fa-exclamation-triangle"></i> {{l('More Info', 'absrc/layouts')}}</a>
@endif
...
@include('absrc.catalogue._modal_view_product')

@include('absrc.catalogue._modal_out_of_stock')
