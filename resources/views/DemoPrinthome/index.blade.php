...
<div id="msgInstallWCPP" style="display:none;">
    ...
    <p>
        <a href="{{action('DemoPrintHomeController@samples')}}" class="btn btn-info">You can go and test the printing page...</a>
    </p>
...
<script type="text/javascript">
            ...
            function wcppDetectOnSuccess(){
                ...
                if(wcppVer.substring(0, 1) == "5")
                    window.location.href = '{{action('DemoPrintHomeController@samples')}}';
